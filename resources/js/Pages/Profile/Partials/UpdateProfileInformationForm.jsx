...
export default function UpdateProfileInformation({
  ...
  return (
    <section className={className}>
      <header>
        <h2 className="mk-card-title">Información del perfil</h2>
      ...
      <form onSubmit={submit} className="mt-6 space-y-6">
        <div className="flex items-start gap-4">
          <div className="w-24 h-24 rounded-full overflow-hidden border" style={{ borderColor: 'rgba(255,255,255,0.06)' }}>
            <img
              src={preview}
              alt="Foto de perfil"
          ...
          <div>
            <p className="mt-2 text-sm" style={{ color: 'rgba(255,255,255,0.85)' }}>
              ...
              <Link
                ...
                method="post"
                as="button"
                className="mk-link-button rounded-md text-sm ms-2"
              >
            ...
            {status === 'verification-link-sent' && (
              <div className="mt-2 text-sm font-medium" style={{ color: '#76c893' }}>
